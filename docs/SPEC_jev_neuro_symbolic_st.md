...
- [x] 포위(`flanked=1`) 재현 — 적 집계를 '최근 2초 안에 본 적' 으로 바꾸고(`08ed190b`) 동시 감지 요청을 교체형으로(`96669d5e`) 한 뒤 count=3 flanked=1 관측(2026-09-24).
- [x] 체력 저하 시 Flee — HP 25% 교차 트리거 동작 확인(2026-09-24). 1:1 에선 교차 순간 확신도 <0.5 라 중립, 적 2명·HP ≲15% 에서 Flee ≥0.58.
- [x] 네트워크 강제 단절 시 Jev 요청 0건·C++ 반사 공격 정상(2026-09-24).
