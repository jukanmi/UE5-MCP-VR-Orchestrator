 ...
 *
 * 윈도우 동안 소유 ACombatCharacter(SmartNPC·EnemyCharacter)의 PerformAttackHit 을 매 틱 호출 → 타겟이 거리·arc 게이트를
 * 통과하면 1회 데미지(스윙당 1회 가드는 캐릭터가 보유). 판정 로직 자체는 ACombatCharacter 에 둔다
